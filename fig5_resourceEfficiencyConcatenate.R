...
{
  filepath <- paste0('/data/jux/BBL/projects/ASLnetwork/scripts/zaixuRepro/data/resource_efficiency0',i,'_send.txt')
...
for (i in c(999,98,96,94,92,9,8,7,6,5,4,3,2,1))
{
  filepath <- paste0('/data/jux/BBL/projects/ASLnetwork/scripts/zaixuRepro/data/resource_efficiency0',i,'_receive.txt')
